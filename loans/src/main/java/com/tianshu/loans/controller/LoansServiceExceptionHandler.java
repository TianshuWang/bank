...
import com.tianshu.loans.exception.ResponseException;
...
@ControllerAdvice
public class LoansServiceExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({EntityNotFoundException.class, LoanNotFoundByCustomerIdException.class})
